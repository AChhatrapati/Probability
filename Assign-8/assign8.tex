...
\begin{align}
\pr{Y \ge 12} &= \qfunc{\frac{11.5-\mu}{\sigma}}\\
\pr{Y \ge 12} &= \qfunc{0.3\times\sqrt{5}}=\qfunc{0.67}\\
\implies \pr{Y \ge 12} &= 0.2511
\end{align}
\item Without correction:
\begin{align}
\pr{Y \ge 12} &= \qfunc{\frac{12-\mu}{\sigma}}\\
\pr{Y \ge 12} &= \qfunc{0.894}\\
\implies \pr{Y \ge 12} &= 0.1855
\end{align}
\end{enumerate}
\textbf{Binomial}
\begin{align}
