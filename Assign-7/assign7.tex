...
\solution\\
Residual sum of squares(RSS):Measures the level of variance in the error term, or residuals, of a regression model.
$$RSS=\sum \brak{y_i-\hat{y}}^2$$
Total sum of squares(TSS):A variation of the values of a dependent variable from the sample mean of the dependent variable.
