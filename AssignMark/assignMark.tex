...
\end{align}
\begin{align}
\pr{X_2=1|X_1=1,X_3=2} &= p_{X_2,X_1}(1,1)
\end{align}
(by markov's property)\\
Let's calculate $p_{X_2,X_1}(1,1)$ using transition probability matrix
\begin{align}
\implies p_{X_2,X_1}(1,1) = p_{11} &= \frac{1}{2}\\
\implies \pr{X_2=1|X_1=1,X_3=2} &= 0.5
\end{align}
\end{document}
