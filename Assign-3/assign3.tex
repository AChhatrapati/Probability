...
\begin{align}
	 X &=
	\begin{cases}
		1, & \text{if a triangle piece is lost}\\ 
		0, & \text{otherwise}
	\end{cases}\\
	Y &=
	\begin{cases}
		1, & \text{if a square piece is lost}\\ 
		0, & \text{otherwise}
	\end{cases}\\
	A &=
	\begin{cases}
		1, & \text{if blue piece is lost}\\ 
		0, & \text{otherwise}
	\end{cases}\\
	B &=
	\begin{cases}
		1, & \text{if red piece is lost}\\ 
		0, & \text{otherwise}
	\end{cases}
\end{align}
\begin{enumerate}
\item $p_X\brak{1}=\frac{8}{18}$
\item $p_Y\brak{1}=\frac{10}{18}$
\item $p_{YA}\brak{1}=\frac{6}{18}$
\item $p_{XB}\brak{1}=\frac{5}{18}$
\end{enumerate}
