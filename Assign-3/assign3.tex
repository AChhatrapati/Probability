...
\hline
\end{tabular} 
$p_X\brak{X=0}=\frac{10}{18}\\
p_X\brak{X=1}=\frac{8}{18}\\
p_X\brak{Y=0}=\frac{9}{18}\\
p_X\brak{Y=1}=\frac{9}{18}$
\begin{enumerate}
\item $p_X\brak{1}=\frac{8}{18}$
\item $p_X\brak{0}=\frac{10}{18}$
\item $p_{XY}\brak{X=0,Y=1}=\pr{Y=1|X=0}p_{X}\brak{0}\\=\frac{6}{10}\times \frac{10}{18}=\frac{6}{18}$
\item $p_{XY}\brak{X=1,Y=0}=\pr{Y=0|X=1}p_{X}\brak{1}\\=\frac{5}{8}\times \frac{8}{18}=\frac{5}{18}$
\end{enumerate}
