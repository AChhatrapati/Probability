...
\hline
Pieces & Blue coloured & Red coloured & Total number \\
\hline
Triangle & 3 & 5 & 8 \\
\hline
Square & 6 & 4 & 10 \\ 
...
\end{tabular} 
\begin{enumerate}
\item Probability for lost piece is triangle=$\frac{8}{18}$
\item Probability for lost piece is square=$\frac{10}{18}$
\item Probability for lost piece is blue square=$\frac{6}{18}$
\item Probability for lost piece is red triangle=$\frac{5}{18}$
\end{enumerate}
